...
import { createAssignment, getAllAssignments, getAssignmentById, updateAssignment, deleteAssignment, getMonitorStats, getStudentStats, } from '../controllers/assignmentController.js';
import { submitAssignment, getAssignmentSubmissions, deleteSubmission } from '../controllers/submissionController.js';
const router = Router();
